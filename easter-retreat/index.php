...
if(isset($_POST['getmydp'])){
    ...
    $myDP = Image::make('img/myRetreatExperience_1080_2.jpg');

    $myDP->insert($image, 'top-left', 85, 299);
	...
	//Add Image
	// $myDP->insert($image, 'top-left', 385, 299);
  ...
  <body class="bodyWrap">
    ...
    <main class="form-getLetter">
        <div class="baseImg-wrap">
            <img src="img/myRetreatExperience_1080_2.jpg" class="w-100">
            <div class="myImage rounded-0" id="myImage">
                <img id="myImageTag" src="./img/plus-lg.png" alt="myImageTag" height="105" class="w-100 h-auto"/>
            </div>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-1">
          <input type="text" class="form-control" id="district" name="district" placeholder="Your Retreat Location" required>
          <label for="district">Your Retreat Location</label>
        </div>
