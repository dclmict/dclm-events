...
if(isset($_POST['getmydp'])){
    ...
    $myDP = Image::make('img/gck-exp.jpg');
    $myDP->insert($image, 'top-left', 340, 291);
            ...
            <div class="col-sm-6 order-2 order-sm-1">
                <main class="form-getLetter">
                  ...
                  <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <h1 class="h6 mb-y fw-bold text-light form-head">Share Your GCK Experience</h1>
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="district" name="district" placeholder="City, Country" maxlength="70" required>
                      <label for="district">City, Country</label>
                    </div>
                    ...
                    <button name="getmydp" class="w-100 btn btn-lg btn-danger mt-3 mk-btn fw-bold" type="submit">Share Experience</button>
                  </form>
                </main>            
            </div><!-- //.col-sm-6 -->
