<div class="row">
    <div class="col-12 col-sm-6">
        ...
        @php($selectMonth = ($formMode == 'edit') ? $program->event_type : old('event_type')  )
        <div class="form-group">
            <label class="fw-bold" for="category">Event type:</label>
            <select class="form-control" id="category" name="category">
                <option value="State" @if ($selectMonth == 'State') selected @endif>State</option>
                <option value="Global" @if ($selectMonth == 'Global') selected @endif>Global</option>
                <option value="National" @if ($selectMonth == 'National') selected @endif>National</option>
            </select>
        </div>
            ...
            <table class="table">
                ...
                <tbody id="fieldTable">
                    @if ($formMode == 'edit')
                        ...
                        <tr>
                            <td><input type="time" step="300"  value="{{ $s->time }}" class="form-control form-control-s," name="time[]" placeholder="Time" required></td>
                    ...
                    @else
                    <tr>
                        <td><input type="time" step="300" class="form-control form-control-s," name="time[]" placeholder="Time" required></td>
