...
if(isset($_POST['getmydp'])){
    ...
    $dist = [
        ...
        'size'   => 14,
        'angle'  => 0,
        // 'color'  => (isset($color)) ? $color : "#222222",
        'color'  => "#9b3800",
        'pos'    => "center",
    ];

    $myDP = Image::make('img/share.jpeg');
    $myDP->insert($image, 'top-left', 185, 275);
  ...
  <body class="bodyWrap">
    ...
    <main class="form-getLetter">
        <div class="baseImg-wrap">
            <img src="img/share.jpeg" class="w-100">
            <div class="myImage" id="myImage">
                <img id="myImageTag" src="./img/plus-lg.png" alt="myImageTag" height="105" class="w-auto h-100"/>
            </div>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <h1 class="h6 mt-3 mb-3 fw-bold text-light">Share your GYC Experience</h1>
        ...
        <button name="getmydp" class="w-100 btn btn-lg btn-danger mt-3" type="submit">Share My Experience</button>
      </form>
    </main>
