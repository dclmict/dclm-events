...
<head>
    ...
    <!-- SITE TITLE -->
    <title>EVENT @if($program)| {{ strtoupper($program->name) }}@endif</title>
    ...
    <!-- <style>
        ...
        .lgx-tab-content, .lgx-nav, .lgx-nav-colorful, .lgx-tab, .lgx-nav{
...
<style type="text/css">
@if(!$program)
.lgx-banner.lgx-banner16{
    background: url('assets/img/supernatural-deliverance-from-christ.jpg') top center no-repeat !important;
...
#publicize-me{
    padding-top: 80px;
    padding-bottom: 80px;
    background-color: #2bdaf3;
}
#publicize-me .inner-box{
    max-width: 960px;
    margin: auto;
}
#publicize-me .inner-text{
    padding-top: 30px;
    padding-bottom: 30px; 
}
...
<!--BANNER-->
<section>
    <div @if($program) style="background: url({{ asset('storage/'.$program->image_location ?? 'storage/supernatural-deliverance-from-christ.jpg') }}) top center no-repeat !important; -webkit-background-size: contain !important; -o-background-size: contain !important; -moz-background-size: contain !important; background-size: contain !important;" @endif class="lgx-banner lgx-banner16">
...
<section id="publicize-me" class="lgx-container-fluid px-3">
    <div class="inner-box">
        <div class="row">
            <div class="col-sm-6 text-center">
                <img src="/assets/img/publisize-me.png" width="300">
            </div>
            <div class="col-sm-6">
                <div class="inner-text">
                    <h3 class="title">PUBLISIZE IT</h3>
                    <p>As we excitedly anticipate the Global Impact Academy for Youths, we must earnestly
reach to proclaim and blaze it abroad</p>
                    <br>
                    <a class="lgx-btn lgx-btn-red btn-sm" href="/personalizedflyer">Personalyzed Flyer</a>
                </div>
            </div>
        </div>
    </div>
